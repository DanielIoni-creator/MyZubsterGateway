...
public final class ActivityRegisterBinding implements ViewBinding {
  ...
  private ActivityRegisterBinding(@NonNull ScrollView rootView, @NonNull ImageButton btnBack,
      ...
      @NonNull TextInputLayout tilPassword, @NonNull TextView tvError, @NonNull TextView tvLogin) {
  ...
  public static ActivityRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegisterBinding((ScrollView) rootView, btnBack, btnRegister,
          etConfirmPassword, etEmail, etName, etPassword, etUsername, progressBar,
          tilConfirmPassword, tilPassword, tvError, tvLogin);
    }
