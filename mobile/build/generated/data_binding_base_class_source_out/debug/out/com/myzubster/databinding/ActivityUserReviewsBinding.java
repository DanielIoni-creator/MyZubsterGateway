...
public final class ActivityUserReviewsBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityUserReviewsBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static ActivityUserReviewsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityUserReviewsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_user_reviews, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityUserReviewsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityUserReviewsBinding((LinearLayout) rootView, progressBar, recyclerView,
