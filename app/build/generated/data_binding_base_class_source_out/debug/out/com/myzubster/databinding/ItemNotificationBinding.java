...
public final class ItemNotificationBinding implements ViewBinding {
  ...
  private ItemNotificationBinding(@NonNull CardView rootView, @NonNull CardView cardView,
      @NonNull ImageView ivIcon, @NonNull TextView tvMessage, @NonNull TextView tvTime,
      @NonNull TextView tvTitle, @NonNull View vUnread) {
  ...
  public static ItemNotificationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemNotificationBinding((CardView) rootView, cardView, ivIcon, tvMessage, tvTime,
          tvTitle, vUnread);
    }
