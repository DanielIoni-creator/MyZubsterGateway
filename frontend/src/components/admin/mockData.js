...
// --- Compliance / SG-7 data ---
export const complianceStats = [
  { id: 'verified', label: 'Verified Wallets', value: '8,356', delta: '+12.4%', trend: 'up', accent: 'emerald' },
  { id: 'pending', label: 'Pending KYC', value: '423', delta: '-5.2%', trend: 'down', accent: 'amber' },
  { id: 'flagged', label: 'Flagged', value: '87', delta: '+18.7%', trend: 'up', accent: 'rose' },
  { id: 'total', label: 'Total Wallets', value: '12,804', delta: '+7.8%', trend: 'up', accent: 'sky' },
];

export const complianceWallets = [
  { id: 1, address: '0x1a2b...3c4d', holder: 'Aria Bellini', type: 'personal', kyc: 'verified', verified: '2026-06-14', country: 'IT', volume: '42,500', risk: 'low', lastActive: '2026-08-04' },
  { id: 2, address: '0x4e5f...6g7h', holder: 'Kenji Sato', type: 'business', kyc: 'verified', verified: '2026-05-22', country: 'JP', volume: '128,300', risk: 'low', lastActive: '2026-08-04' },
  { id: 3, address: '0x8i9j...0k1l', holder: 'Luca Romano', type: 'personal', kyc: 'pending', verified: '—', country: 'IT', volume: '3,200', risk: 'medium', lastActive: '2026-08-03' },
  { id: 4, address: '0x2m3n...4o5p', holder: 'Mara Kovac', type: 'personal', kyc: 'pending', verified: '—', country: 'HR', volume: '1,050', risk: 'medium', lastActive: '2026-08-02' },
  { id: 5, address: '0x6q7r...8s9t', holder: 'Diego Ferri', type: 'business', kyc: 'suspended', verified: '2026-04-10', country: 'IT', volume: '67,800', risk: 'high', lastActive: '2026-08-01' },
  { id: 6, address: '0x0u1v...2w3x', holder: 'Sofia Marchetti', type: 'personal', kyc: 'verified', verified: '2026-07-01', country: 'IT', volume: '18,900', risk: 'low', lastActive: '2026-08-04' },
  { id: 7, address: '0x4y5z...6a7b', holder: 'Tomas Novak', type: 'business', kyc: 'verified', verified: '2026-03-15', country: 'CZ', volume: '95,400', risk: 'low', lastActive: '2026-08-04' },
  { id: 8, address: '0x8c9d...0e1f', holder: 'Yuki Tanaka', type: 'personal', kyc: 'verified', verified: '2026-07-28', country: 'JP', volume: '24,600', risk: 'low', lastActive: '2026-08-03' },
];

export const suspiciousTransactions = [
  { id: 'TX-9821', wallet: '0x6q7r...8s9t', holder: 'Diego Ferri', amount: '12,500 MYZ', type: 'large-transfer', risk: 'high', detected: '2026-08-04 09:32', status: 'investigating', notes: 'Multiple rapid transfers to new address' },
  { id: 'TX-9817', wallet: '0x8i9j...0k1l', holder: 'Luca Romano', amount: '4,200 MYZ', type: 'non-kyc', risk: 'medium', detected: '2026-08-04 07:15', status: 'pending', notes: 'Transaction from non-KYC wallet' },
  { id: 'TX-9809', wallet: '0x2m3n...4o5p', holder: 'Mara Kovac', amount: '2,800 MYZ', type: 'velocity', risk: 'medium', detected: '2026-08-03 22:44', status: 'pending', notes: '3 transactions in 10 minutes' },
  { id: 'TX-9802', wallet: '0x4e5f...6g7h', holder: 'Kenji Sato', amount: '50,000 MYZ', type: 'large-transfer', risk: 'low', detected: '2026-08-03 14:20', status: 'cleared', notes: 'Whitelisted business transfer' },
  { id: 'TX-9795', wallet: '0x1a2b...3c4d', holder: 'Aria Bellini', amount: '1,200 MYZ', type: 'unusual-pattern', risk: 'low', detected: '2026-08-02 11:05', status: 'cleared', notes: 'Unusual time of day, known pattern' },
  { id: 'TX-9788', wallet: '0x6q7r...8s9t', holder: 'Diego Ferri', amount: '8,900 MYZ', type: 'geo-anomaly', risk: 'high', detected: '2026-08-02 06:30', status: 'investigating', notes: 'Login from IP outside usual region' },
];

export const complianceAlerts = [
  { id: 1, severity: 'critical', message: 'Wallet 0x6q7r...8s9t exceeded daily velocity limit', time: '2m ago', source: 'auto-detection' },
  { id: 2, severity: 'warning', message: 'KYC doc for Mara Kovac expires in 7 days', time: '15m ago', source: 'kyc-engine' },
  { id: 3, severity: 'info', message: 'Monthly compliance report ready for review', time: '1h ago', source: 'scheduler' },
  { id: 4, severity: 'warning', message: 'New regulation SG-7 requires additional wallet fields', time: '3h ago', source: 'admin' },
  { id: 5, severity: 'critical', message: 'Multiple failed login attempts on admin console', time: '5h ago', source: 'auth' },
  { id: 6, severity: 'info', message: 'Wallet backup completed: 12,804 records', time: '8h ago', source: 'system' },
];